...
int main() {
    int** result = generate_unsorted_array();
    output_array(result);
//    bubble_sort(result[0], default_generate_length);
//    select_sort(result[0],default_generate_length);
    insert_sort(result[0],default_generate_length);
    output_array(result);
}
